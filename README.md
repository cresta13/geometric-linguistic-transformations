...
- The 2026-06-29 9-model GLT-MOLT affine/operator audit shows that additive deltas remain better target predictors, while learned linear/affine maps show weak but systematic matrix-commutator closure and low Jacobi-like operator norms.
