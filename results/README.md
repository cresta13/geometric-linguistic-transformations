...
- `glt_steer_confirmatory_fixed_params_20260825_results/`
  - `SUMMARY.md`: fixed-parameter confirmatory audit for question, exclamation, and ellipsis steering on fresh hard-heldout sources.
  - `csv/glt_steer_confirmatory_raw.csv`: `6480` generated outputs with marker/content flags.
